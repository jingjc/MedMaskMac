...
struct PrivateOCRRegressionMain {
    static func main() async {
        ...
        do {
            ...
            print("strictHospitalSingleCandidate=\(result.strictHospitalSingleCandidate)")
            print("strictHospitalFullName=\(result.strictHospitalFullName)")
            print("strictHospitalNoAddressPollution=\(result.strictHospitalNoAddressPollution)")
            print("strictHospitalNotSuffixOnly=\(result.strictHospitalNotSuffixOnly)")
            ...
            print("strictStaffNotMergedIntoName=\(result.strictStaffNotMergedIntoName)")
            print("standardRegressionStillPassing=\(result.standardRegressionStillPassing)")
